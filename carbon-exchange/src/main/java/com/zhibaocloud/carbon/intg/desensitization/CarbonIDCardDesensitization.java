...
public class CarbonIDCardDesensitization implements CarbonStringDesensitization {
   ...
   * 15位身份证号正则
   */
  private static final Pattern PATTERN15 = Pattern.compile(
      "^([1-9][0-9]{5}[0-9]{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)[0-9]{3})$");
  /**
   * 18位身份证号正则
   */
  private static final Pattern PATTERN18 = Pattern.compile(
  ...
  public String desensitize(String original) {
    original = desensitize(PATTERN18, original);
    return desensitize(PATTERN15, original);
  }
